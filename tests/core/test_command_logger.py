...
class TestCommandLogger:
    ...
    def test_command_logger_initialization(self, mock_config_class, mock_discord_context, mock_logger):
    ...
    @patch('core.CommandLogger.Config')
    def test_command_logger_without_command_data(self, mock_config_class, mock_discord_context, mock_logger):
    ...
    @patch('core.CommandLogger.Config')
    def test_command_logger_gets_bot_variant(self, mock_config_class, mock_discord_context, mock_logger):
    ...
    @patch('core.CommandLogger.Config')
    def test_command_logger_log_method(self, mock_config_class, mock_discord_context, mock_logger):
    ...
    @patch('core.CommandLogger.Config')
    def test_command_logger_creates_message_wrapper(self, mock_config_class, mock_discord_context, mock_logger):
