...
class TestErrorHandler:
    ...
    def test_error_handler_initialization_with_context(self, mock_discord_context, mock_logger):
    ...
    def test_error_handler_extracts_message_content(self, mock_discord_context, mock_logger):
    ...
    def test_error_handler_message_wrapper_creation(self, mock_discord_context, mock_logger):
    ...
    def test_error_handler_stores_all_parameters(self, mock_discord_context, mock_logger):
