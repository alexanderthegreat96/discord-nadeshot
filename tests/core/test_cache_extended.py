...
class TestCacheEnqueueItem:
    ...
    def test_cache_enqueue_item(
        self, mock_from_root, mock_env_parser_class, mock_redis_class
    ):
    ...
    @patch("core.Cache.EnvParser")
    @patch("core.Cache.from_root")
    def test_cache_enqueue_item_unique(
        self, mock_from_root, mock_env_parser_class, mock_redis_class
    ):
...
class TestCacheEnvironmentConfiguration:
    ...
    @patch("core.Cache.EnvParser")
    @patch("core.Cache.from_root")
    def test_cache_uses_redis_host_env_var(
        self, mock_from_root, mock_env_parser_class, mock_redis_class
    ):
    ...
    @patch("core.Cache.EnvParser")
    @patch("core.Cache.from_root")
    def test_cache_with_custom_global_key(
        self, mock_from_root, mock_env_parser_class, mock_redis_class
    ):
